...
connection_string = f"mongodb+srv://derya:{password}@cluster0.afc45yb.mongodb.net/?retryWrites=true&w=majority"
...
def update_documents(person_id):
    from bson.objectid import ObjectId
    _id = ObjectId(person_id)
